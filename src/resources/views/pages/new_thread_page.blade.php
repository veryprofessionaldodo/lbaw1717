    ...
    <div id="overlay">
        <div class="jumbotron">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="thread_title" placeholder="Title..." id="title">
            </div>
            <div class="form-group">
                <label class="col-form-label" for="description">Insert the description of the issue: </label>
                <textarea class="form-control" id="description" name="thread_description" placeholder ="Description..." rows="5"></textarea>
            </div>
            <p class="lead">
                <a user="{{Auth::user()->username}}" class="btn btn-primary btn-lg" id="newThread-btn" href="{{ route('new_thread_action', ['id' => $project->id])}}" role="button">Create</a>
            </p>
        </div>   
    </div>
</div>
