<div data-id="{{ $report->id }}"class="report report_comment col-12">
	<div class="report_principal_info">
		...
		<a class="info"href="{{ route('commentReportView', ['report_id' => $report->id])}}">More info</a>
		<div class="options">
			<button href="{{ route('deleteCommentReport', ['report_id' => $report->id])}}"  onclick="deleteCommentReport(this)" class="btn">Delete Comment</button>
